...
(custom-set-variables
 ...
 '(package-selected-packages
   '(backup-each-save baidu-translate company eaf-markmap elfeed embark-consult epc flycheck fzf indent-guide keycast keyfreq lsp-python-ms lsp-treemacs lsp-ui marginalia mood-one-theme multiple-cursors orderless org-bullets org-download org-roam-ui ox-hugo pandoc-mode rainbow-delimiters rg rust-mode smartparens swiper treemacs-icons-dired treemacs-persp treemacs-projectile treesit-auto vertico web-mode wgrep which-key window-numbering yasnippet-snippets youdao-dictionary))
